...
| [dsl-vm-reverse](reverse-engineering/dsl-vm-reverse/SKILL.md) | 逆向基于 JavaScript 实现的自定义虚拟机/风控引擎（IIFE + switch-case opcode DSL VM）。适用于 DSL VM、自定义指令集、fireye/getToken 类前端风控引擎、opcode VM 逆向，以及 582KB 大 JS 非 WASM 文件的 VM 分类与脱密。 |
